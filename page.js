...
export default function Home() {
  ...
  const hardCodedResponses = {
    ...
    "I do not understand": "I apologize. If you do not understand my response, I could try rephrasing it or providing more details. You can also ask in a different way or let me know if you need clarification on a specific topic mentioned."
  }
